...
DeckGUI::DeckGUI(DJAudioPlayer* _player,
    ...
    auto loadImage = ImageCache::getFromMemory(BinaryData::load_png, BinaryData::load_pngSize);

    playButton.setImages(true, true, true, playImage, 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentBlack);
    pauseButton.setImages(true, true, true, pauseImage, 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentBlack);
    stopButton.setImages(true, true, true, stopImage, 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentBlack);
    loadButton.setImages(true, true, true, loadImage, 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentWhite, Image(nullptr), 1, Colours::transparentBlack);
